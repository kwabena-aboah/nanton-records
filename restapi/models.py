...
class Received(models.Model):
    registry_number = models.CharField(max_length=8, help_text="File Name. Automatically generated")
    ...
    date_recieved = models.DateTimeField(auto_now_add=False)
...
class Dispatched(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    date_dispatched = models.DateTimeField(auto_now_add=False)
